        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <a class="text-body mr-3" href="{{route('dashboard')}}">About</a>
                    <a class="text-body mr-3" href="{{route('a-user')}}">Contact</a>
                    <a class="text-body mr-3" href="{{route('a-create')}}">Help</a>
